 ...
 */
 ...
 function checkQuizz() {
    ...
    if (question1 == "Sean Connery") {
        correct++;
    }
    if (question2 == "Snow White") {
        correct++;
    }
    if (question3 == "6") {
        correct++;
    ...
    document.getElementById("answers").innerHTML = "Answers<br>Q1-Sean Connery,<br> Q2-Snow White<br>Q3-6<br>Q4-Avatar<br>Q5-Gale";
    setTimeout(() => {
